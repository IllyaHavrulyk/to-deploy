...
// @public
export const getThemeHtmlAttrs: ({ colorMode, dark, light, spacing, typography, }?: Partial<ThemeState>) => Record<string, string>;

// @public
export const getThemeStyles: ({ colorMode, dark, light, spacing, typography, }?: Partial<ThemeState>) => Promise<ThemeStyles[]>;
